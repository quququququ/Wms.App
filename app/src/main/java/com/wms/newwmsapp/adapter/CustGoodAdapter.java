...
public class CustGoodAdapter extends DataAdapter<CustGoodModel>{

	public CustGoodAdapter(Context context) {
        super(context);
    }

    public CustGoodAdapter(Context context, boolean isCircle) {
	...
	public View getLayout(int position, DataViewHolder vh, ViewGroup parent) {
		// TODO Auto-generated method stub
		return getResourceView(R.layout.adapter_custgood_item);
	}
}
