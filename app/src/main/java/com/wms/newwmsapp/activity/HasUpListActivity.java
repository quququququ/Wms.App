...
import com.wms.newwmsapp.adapter.HasUpToOtherAdapter;
...
public class HasUpListActivity extends BaseActivity implements HasUpToOtherAdapter.DownToOtherListener {
    private List<UpToOtherListModel.DataBean> downDataList = new ArrayList<UpToOtherListModel.DataBean>();
    private HasUpToOtherAdapter mAdapter;
    ...
    private void initView() {
        ...
        downDataList = (List<UpToOtherListModel.DataBean>) getIntent().getSerializableExtra("upData");
        lvDownList = (ListView) findViewById(R.id.lv_down_list);
        mAdapter = new HasUpToOtherAdapter(this);
