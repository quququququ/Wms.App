...
public class PickUpOtherActivity extends BaseActivity {
    ...
    public static PickUpOtherActivity pickUpOtherActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_name.setText("转仓分拣");
        pickUpOtherActivity = this;
    ...
    private void getPickUpList(final String pickUpConfirmCode) {
        ...
        RequestQueue mRequestQueue = Volley
                .newRequestQueue(PickUpOtherActivity.this);
                ...
                try {
                    ...
                    if (pickUpadapter == null) {
                        pickUpadapter = new WavePickupConfirmAdapter(
                                PickUpOtherActivity.this, true, "PickUpOtherActivity", isOther);
