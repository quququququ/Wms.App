...
public class GoodsPosModel implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7295788026281658334L;
	public String GoodsPosCode;//货位Code
	public String GoodsPosName;//货位Name
	public int Num;//数量(预计)
	public int Loc_Num=0;//数量(实上架数量:本地生成)
	public String Code;//主键
